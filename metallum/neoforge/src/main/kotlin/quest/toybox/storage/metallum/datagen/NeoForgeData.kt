...
@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, modid = EllsSM.MOD_ID)
object NeoForgeData {
    @JvmStatic
    @SubscribeEvent
    fun gatherData(event: GatherDataEvent) {
        val generateCommonData = System.getProperty("storagemetallum.datagen.common", "false") == "true"
